 ...
 * @para[first]: first. First element of this path
 **/
 ...
 * @para[in]: cost_path. Pointer of integer, length = n_cities.
...
#pragma omp parallel for num_threads(p)
	for (int i = 0; i < n_cities; i++)
	{
		...
		while (cnt < 2000)
		{
			...
			// because of the error introduced by floating arithmatic
			// we need to recalculate the cost in a period of time
